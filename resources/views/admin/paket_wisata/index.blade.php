                ...
                <tr class="hover:bg-gray-50 transition items-center">
                    ...
                    <td class="p-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route('admin.paket-wisata.edit', $item->id) }}" title="Edit Data" class="p-2.5 bg-amber-50 text-amber-600 hover:bg-amber-500 hover:text-white rounded-xl transition shadow-sm">
