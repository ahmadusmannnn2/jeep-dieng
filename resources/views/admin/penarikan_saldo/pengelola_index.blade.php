                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6 text-center">
                            ...
                            @elseif($riwayat->status == 'Ditransfer')
                                ...
                                <form action="{{ route('admin.penarikan-saldo.confirm', $riwayat->id) }}" method="POST" class="mt-2" onsubmit="return confirm('Apakah Anda yakin telah menerima dana penarikan ini sesuai bukti transfer?');">
                                    @csrf
                                    @method('PUT')
