            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 flex justify-center gap-2">
                        ...
                        <a href="{{ route('booking.print', $item->id) }}" target="_blank" title="Cetak e-Tiket" class="p-2.5 bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl transition shadow-sm">
