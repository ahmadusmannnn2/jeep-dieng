...
@section('title', 'Tambah Rute Wisata - Jeep Dieng')
@section('header_title', 'Tambah Destinasi Rute')
@section('header_subtitle', 'Masukkan detail tujuan wisata baru')
...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 max-w-2xl mx-auto">
    <form action="{{ route('admin.rute-wisata.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="nama_rute" required placeholder="Contoh: Kawah Sikidang" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Deskripsi Tempat</label>
            <textarea name="deskripsi" rows="4" placeholder="Jelaskan daya tarik destinasi ini..." class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition"></textarea>
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Foto Destinasi (Opsional)</label>
            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-2xl bg-gray-50 hover:bg-gray-100 transition relative overflow-hidden" id="drop-area">
                ...
                <div class="space-y-2 text-center z-10 relative" id="upload-placeholder">
                    ...
                    <div class="flex justify-center text-sm text-gray-600">
                        <label for="file-input" class="relative cursor-pointer bg-white rounded-md font-bold text-emerald-600 hover:text-emerald-500 px-3 py-1 shadow-sm border border-gray-200">
                ...
                <div id="image-preview-container" class="hidden absolute inset-0 z-20 bg-white flex flex-col items-center justify-center p-2">
                    ...
                    <label for="file-input" class="mt-2 cursor-pointer text-xs font-bold text-red-500 hover:text-red-700">
                        Ganti Gambar
                    </label>
                </div>
