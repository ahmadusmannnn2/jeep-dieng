<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div>
            ...
            <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="contoh@gmail.com" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
        ...
        <div>
            ...
            <input id="password" type="password" name="password" required autocomplete="current-password" placeholder="••••••••" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
        ...
        <div class="pt-2">
            <button type="submit" class="w-full px-8 py-3.5 bg-gray-900 text-white font-bold rounded-xl hover:bg-emerald-500 transition shadow-lg hover:shadow-emerald-500/30">Masuk Sekarang</button>
        </div>
