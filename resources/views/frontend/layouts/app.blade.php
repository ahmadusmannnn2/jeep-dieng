...
<head>
    ...
    <title>@yield('title', ($pengaturan_website->nama_website ?? 'Jeep Dieng') . ' - Jelajahi Keindahan Alam Dieng')</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
            <div class="flex justify-between items-center h-full">
                ...
                <div class="hidden lg:flex items-center gap-1">
                    ...
                    @auth
                        @if(Auth::user()->role !== 'admin_komunitas' && Auth::user()->role !== 'super_admin')
