    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($paket as $index => $item)
                <div class="bg-gray-50 rounded-3xl p-8 border border-gray-100 hover:border-emerald-500/30 hover:shadow-xl transition-all flex flex-col justify-between">
                    <div>
                        ...
                        <p class="mb-6 text-sm leading-relaxed text-gray-600">{{ $item->deskripsi ?? 'Tidak ada deskripsi spesifik.' }}</p>
                    </div>
